...
var _initialDbSeed = require("./initialDbSeed");
 ...
 */
var initDB = exports.initDB = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          _context.p = 1;
          _context.n = 2;
          return _mongoose["default"].connect(process.env.MONGO_DB_URI);
        case 2:
          console.log("✅ MongoDB connected");

          // 🔑 Seed default expense data
          _context.n = 3;
          return (0, _initialDbSeed.seedExpenseTypes)();
        case 3:
          _context.n = 5;
          break;
        case 4:
